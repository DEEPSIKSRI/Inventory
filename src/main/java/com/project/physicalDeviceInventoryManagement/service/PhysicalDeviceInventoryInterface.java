...
public interface PhysicalDeviceInventoryInterface {
    ResponseEntity< ResponseDTO> createInventory ( InventoryDTO inventoryDTO );

    ResponseEntity< ResponseDTO> listOfInventory ( );

    ResponseEntity< ResponseDTO> particularInventorById ( Integer id );
    ...
    ResponseEntity< ResponseDTO> editInventory ( Integer id , InventoryDTO inventoryDTO );
